    ...
    , ui(new Ui::Futures)
{
    ...
    fgs[0]={0,"飞机",5,12000000,20,0,10,0,0,0,0};
    fgs[1]={1,"海景房",5,5000000,40,0,20,0,0,0,0};
    fgs[2]={2,"游轮",5,2000000,80,0,40,0,0,0,0};
    fgs[3]={3,"红宝石",5,1000000,120,60,0,0,0,0,0};
    fgs[4]={4,"钻石",5,800000,140,0,70,0,0,0,0};
    fgs[5]={5,"汽车",4,200000,120,0,60,0,0,0,0};
    fgs[6]={6,"高档化妆品",4,100000,160,0,80,0,0,0,0};
    fgs[7]={7,"高档服装",4,80000,240,0,120,0,0,0,0};
    fgs[8]={8,"水晶",4,50000,400,0,200,0,0,0,0};
    fgs[9]={9,"工艺品",4,30000,640,0,320,0,0,0,0};
    fgs[10]={10,"电脑",3,10000,280,0,140,0,0,0,0};
    fgs[11]={11,"黄金",3,5000,480,0,240,0,0,0,0};
    fgs[12]={12,"手机",3,3000,640,0,320,0,0,0,0};
    fgs[13]={13,"红酒",3,2000,800,0,400,0,0,0,0};
    fgs[14]={14,"办公桌",3,1000,1280,0,640,0,0,0,0};
    fgs[15]={15,"石油",2,800,400,0,200,0,0,0,0};
    fgs[16]={16,"钢材",2,600,480,0,240,0,0,0,0};
    fgs[17]={17,"煤炭",2,500,560,0,280,0,0,0,0};
    fgs[18]={18,"化肥",2,300,800,0,400,0,0,0,0};
    fgs[19]={19,"图书",2,200,960,0,480,0,0,0,0};
    fgs[20]={20,"药品",1,100,400,0,200,0,0,0,0};
    fgs[21]={21,"茶叶",1,80,480,0,240,0,0,0,0};
    fgs[22]={22,"木材",1,50,640,0,320,0,0,0,0};
    fgs[23]={23,"食品",1,30,800,0,400,0,0,0,0};
    fgs[24]={24,"香烟",1,10,2000,0,1000,0,0,0,0};
...
void Futures::on_pushButton_4_clicked()
{
    ...
    {
        upgrade=true;
        Player::instance()->setCur_money(Player::instance()->getCur_money()-cost_money);
    }
}
